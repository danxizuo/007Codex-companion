...
APP_SERVER_TRANSPORT="$(read_deskrelay_env DESKRELAY_COMPANION_APP_SERVER_TRANSPORT_OVERRIDE "stdio")"
...
APP_SERVER_UNIX_SOCKET_PATH="$(read_deskrelay_env DESKRELAY_COMPANION_APP_SERVER_UNIX_SOCKET_PATH_OVERRIDE)"
APP_SERVER_UNIX_PERSISTENT="$(read_deskrelay_env DESKRELAY_COMPANION_APP_SERVER_UNIX_PERSISTENT_OVERRIDE "1")"
DICTATION_TRANSCRIPTION_MODEL="$(read_deskrelay_env DESKRELAY_DICTATION_TRANSCRIPTION_MODEL "qwen3-asr-1.7b")"
...
<dict>
  ...
  <dict>
    ...
    <key>DESKRELAY_COMPANION_APP_SERVER_UNIX_SOCKET_PATH</key>
    <string>$APP_SERVER_UNIX_SOCKET_PATH</string>
    <key>DESKRELAY_COMPANION_APP_SERVER_UNIX_PERSISTENT</key>
    <string>$APP_SERVER_UNIX_PERSISTENT</string>
    <key>DESKRELAY_DICTATION_TRANSCRIPTION_MODEL</key>
    <string>$DICTATION_TRANSCRIPTION_MODEL</string>
  </dict>
